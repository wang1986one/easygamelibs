================================================================================
    MICROSOFT 基础类库： D3DUIEdit 项目概述
===============================================================================

应用程序向导已为您创建了此 D3DUIEdit 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 D3DUIEdit 应用程序的每个文件的内容摘要。
...
res\Toolbar.bmp
    ...
    更新 D3DUIEdit.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
D3DUIEditDoc.h、D3DUIEditDoc.cpp - 文档
    这些文件包含 CD3DUIEditDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CD3DUIEditDoc::Serialize）。
    此文档将具有下列字符串：
        文件扩展名：      UI
        文件类型 ID：        D3DUI.Document
        主框架标题：  D3DUI
        文档类型名称：       D3DUI
        筛选器名称：         D3DUI Files (*.UI)
        文件的新简称： D3DUI
        文件类型全称： D3DUI.Document
D3DUIEditView.h、D3DUIEditView.cpp - 文档视图
    这些文件包含 CD3DUIEditView 类。
    CD3DUIEditView 对象用于查看 CD3DUIEditDoc 对象。
res\D3DUIEditDoc.ico
    这是一个图标文件，用作 
    CD3DUIEditDoc 类 MDI 子窗口的图标。  此图标包含在主
    资源文件 D3DUIEdit.rc 中。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 D3DUIEdit.pch 的预编译头文件 (PCH)
