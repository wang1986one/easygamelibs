================================================================================
    MICROSOFT 基础类库： USOEdit 项目概述
===============================================================================

应用程序向导已为您创建了此 USOEdit 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 USOEdit 应用程序的每个文件的内容摘要。
...
USOTreeView.h、USOTreeView.cpp
    这些文件包含左框架类 CUSOTreeView，此类派生自
    CTreeView。
res\Toolbar.bmp
    此位图文件用于创建工具栏的平铺图像。
    初始工具栏和状态栏在 CMainFrame 
    类中构造。 使用资源编辑器编辑此工具栏位图，并
    更新 USOEdit.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
USOEditDoc.h、USOEditDoc.cpp - 文档
    这些文件包含 CUSOEditDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CUSOEditDoc::Serialize）。
    此文档将具有下列字符串：
        文件扩展名：      USO
        文件类型 ID：        UniversalSystemObject
        主框架标题：  USOEdit
        文档类型名称：       USO
        筛选器名称：         Universal System Object Files (*.USO)
        文件的新简称： USO
        文件类型全称： UniversalSystemObject
USORightView.h、USORightView.cpp - 文档视图
    这些文件包含 CUSORightView 类。
    CUSORightView 对象用于查看 CUSOEditDoc 对象。
res\USOEditDoc.ico
    这是一个图标文件，用作 
    CUSOEditDoc 类 MDI 子窗口的图标。  此图标包含在主
    资源文件 USOEdit.rc 中。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 USOEdit.pch 的预编译头文件 (PCH)
